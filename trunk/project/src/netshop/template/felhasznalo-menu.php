		...
		<ul>
			...
			<li>
				<ul class="inner">
					...
					<li>
						<a href="profile-update.php">Adatok módosítása</a>
					</li>
					<li>
			...
			<li>
				<ul class="inner">
					<li>
						<a href="check.php">Számlaigénylés</a>
					</li>
					<li>
						<a href="balance.php">Vásárlói egyenleg feltöltés</a>
					</li>
					<li>
						<a href="user-orders.php">Vásárolt termékek kilistázása</a>
					</li>
				</ul>
			</li>
		</ul>
